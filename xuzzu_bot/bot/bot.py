    ...
    async def message_handle_fn():
        ...
        try:
            ...
            async for gen_item in gen:
                ...
                if abs(len(answer) - len(prev_answer)) < 20 and status != "finished":
                    continue
            ...
            #     json.dump(db.get_dialog_messages(user_id), f, indent=4)
...
async def show_balance_handle(update: Update, context: CallbackContext):
    ...
    text = f"Which is <b>{total_n_spent_dollars * 450:.03f}KZT</b>\n"
    text += f"And used <b>{total_n_used_tokens}</b> tokens\n\n"
    text += details_text
